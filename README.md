...
| Cloud | Virtualization, Scaling, Load Balancing |
...
**Steps**
1. Clone the repository: `git clone https://github.com/KishorePandavula/BusPassApplication.git`
2. Import project into Eclipse → File → Import → Existing Projects into Workspace
3. Open MySQL Workbench → Run `sql/buspass_db.sql`
4. Update DB credentials in `DBConnection.java`
5. Right click project → Run As → Run on Server → Select Apache Tomcat
6. Open browser: `http://localhost:8080/BusPassApplication/`
...
- 🔗 [LinkedIn](https://linkedin.com/in/pandavula-kishore)
- 🐙 [GitHub](https://github.com/KishorePandavula)
